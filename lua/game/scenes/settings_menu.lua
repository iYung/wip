...
local _ACTION_LIST   = {"move_up","move_down","move_left","move_right","interact","pick_up","put_down"}
local _ACTION_LABELS = {"Up","Down","Left","Right","Interact","Pick Up","Put Down"}
...
function SettingsMenu.new(settings_state, input, on_save, on_leave)
    ...
    self._sub_btn_y0  = H / 2 - 7 * BTN_GAP / 2 - BTN_H / 2  -- centres 8 sub-screen rows
    return self
end
