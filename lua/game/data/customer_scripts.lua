...
return {
    ...
    -- The Collector (golden lotus, 2 chapters)
    {
        ...
        chapter        = 1,
        accessory      = "anon",
        trigger        = { plant_type = 5, count = 13, min_money = 700 },
        name           = "The Collector",
        voice_pitch    = 0.78,
    ...
    -- Mira (tulip pull, 2-chapter arc)
    {
        ...
        chapter         = 1,
        accessory       = "hair_bow",
        trigger         = { plant_type = 3, count = 16, min_money = 75 },
        name            = "Mira",
        voice_pitch     = 1.35,
    ...
    },
    {
        ...
        chapter        = 2,
        accessory      = "clown",
        trigger        = { plant_type = 4, count = 11, min_money = 300 },
        name           = "Dottie",
        voice_pitch    = 1.28,
        primary_color     = {0.70, 0.50, 0.85, 1},
        secondary_color = {0.40, 0.70, 0.55, 1},
    ...
    },
    {
        ...
        chapter        = 2,
        accessory      = "monocle",
        trigger        = { plant_type = 1, count = 3, min_money = 5 },
        name           = "Sir Moneyton",
        voice_pitch    = 0.88,
        primary_color     = {0.35, 0.58, 0.38, 1},
        secondary_color = {0.55, 0.40, 0.25, 1},
    ...
    },
    {
        ...
        chapter        = 4,
        accessory      = "monocle",
        trigger        = { plant_type = 3, count = 1, min_money = 20 },
        name           = "Sir Moneyton",
        voice_pitch    = 0.88,
        primary_color     = {0.35, 0.58, 0.38, 1},
        secondary_color = {0.55, 0.40, 0.25, 1},
