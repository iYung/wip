...
local schedule = {
    ...
    { pt = 5, target = 32 },   -- Daisy  >= 32  → mechafrog:1 (>=5), dottie:3 (>=7), glen:3 (>=14), romeo:4 (>=8), frogsby:4 (>=12), bloom:4 (>=16), dottie:4 (>=20), glen:4 (>=24), collector:1 (>=32)
    { pt = 6, target = 5  },   -- Lotus  >= 5   → wallace:4 (>=1), chef_brio:4 (>=3), mechafrog:4 (>=5), collector:2 (>=5)
