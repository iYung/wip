...
-- Test 22: Confirm in sub-screen enters capture mode (row 2 is first bindable key = move_up)
open_clean(m)
m._subscreen = "keybinds"
m._subscreen_selected = 2
sim_key(m, "space")
...
do
    ...
    m48._subscreen_selected = 7   -- Return row = 1 (scheme toggle) + 5 (key rows) + 1 (Return)
