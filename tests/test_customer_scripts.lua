...
do
    ...
    ctx.gs.stage3_counts[5] = 1   -- Dottie ch1: trigger plant_type=5, count=1
...
do
    ...
    ctx.gs.stage3_counts[5] = 3   -- Dottie ch2: trigger plant_type=5, count=3
    ctx.gs.seen_scripts = {}
